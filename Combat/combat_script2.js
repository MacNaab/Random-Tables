...
$("#sortable1").append('<li id="Ennemie'+Nbre+'" class="ui-state-default"><div class="grid-container">'+barre1+barre2+'</div><b><span onclick="change(this.id)" id="Ennemie_Nom_'+Nbre+'">'+Nom+'</span></b>, initiative : <span id="Ennemie_Ini_'+Nbre+'">'+Initiative+'</span>, PS: <span id="Ennemie_PV_'+Nbre+'">'+PV+'</span>/'+PV+', Endurance: <span id="Ennemie_STA_'+Nbre+'">'+Endurance+'</span>/'+Endurance+'<span id="Ennemie_Nombre_'+Nbre+'" style="display: none;">0</span></li>');
...
function Add_Méchant_PNJ(){
	...
	for(let i=1;i <= e;i++){
		...
		$("#sortable2").append('<li id="Ennemie'+Nbre+'" class="ui-state-default"><div class="grid-container">'+barre1+barre2+'</div><b><span onclick="change(this.id)" id="Ennemie_Nom_'+Nbre+'">'+Nom+'</span></b>, initiative : <span id="Ennemie_Ini_'+Nbre+'">'+Initiative+'</span>, PS: <span id="Ennemie_PV_'+Nbre+'">'+PV+'</span>/'+PV+', Endurance: <span id="Ennemie_STA_'+Nbre+'">'+Endurance+'</span>/'+Endurance+'<span id="Ennemie_Nombre_'+Nbre+'" style="display: none;">0</span></li>');
		document.getElementById("Ennemie"+Nbre).style.paddingBottom = "25px";
	  	var option = document.createElement("option");
