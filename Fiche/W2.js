...
else if(document.getElementById('Race').value =='Halfelin'){
	if(document.getElementById('Profession').value == '6' || document.getElementById('Profession').value == '8'){
		alert('Un Halfelin ne peut pas pratiquer la magie, il lui est donc impossible d\'être mage ou prêtre.');
	}
}
